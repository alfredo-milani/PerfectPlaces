 ...
 */
public class BoundaryInserimentoLocazione {
    ...
    public BoundaryInserimentoLocazione(){
    ...
    public void memorizzaLocazione(Locazione locazione) throws SerializzazioneException, DeserializzazioneException {
