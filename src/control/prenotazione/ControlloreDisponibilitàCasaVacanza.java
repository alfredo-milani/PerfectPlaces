...
public class ControlloreDisponibilitàCasaVacanza extends ControlloreDisponibilità {
    ...
    public boolean controllo(Locazione loc, GregorianCalendar gcInizio, GregorianCalendar gcFine,String numeroPersone) throws DeserializzazioneException, SerializzazioneException, IOException {
        ...
        File file = new File(percorsoPrenotazioniCaseVacanza);
        ...
        if (file.length() == 0) {
            ...
            sobj.serializza(prenotateList, percorsoPrenotazioniCaseVacanza);
            return true;
        } else {
            DeserializzaOggetti dobj = new DeserializzaOggetti();
            prenotateList = (ArrayList<PostiDisponibili>) dobj.deserializza(percorsoPrenotazioniCaseVacanza);
            for (GregorianCalendar data_prenotazione : datePrenotazione) {
