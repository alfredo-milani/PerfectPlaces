...
public class ControlloreRegistraPrenotatiBeb extends ControlloreRegistraPrenotati {
    ...
    public void registra(String nomeLocazione, String proprietario, String cliente, GregorianCalendar dataInizio, GregorianCalendar dataFine, String tipo, String prezzo,String numeroPersone) throws SerializzazioneException, DeserializzazioneException {
        ...
        File file =  new File(percorsoPrenotatiBeb);
        if(file.length()==0){
            ...
            sobj.serializza(listaPrenotazione,percorsoPrenotatiBeb);

        }else{

            DeserializzaOggetti dobj = new DeserializzaOggetti();
            listaPrenotazione = (ArrayList<Prenotazione>) dobj.deserializza(percorsoPrenotatiBeb);
